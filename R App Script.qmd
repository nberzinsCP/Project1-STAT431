...
energy_data_2012 <- map_df(sheets_2012, ~ read_excel(here::here("Project1-STAT431", "generation_monthly.xlsx"), sheet = .x))
...
map_data <- data.frame(name = levels(as.factor(energy_data$name)), 
                       ...
                       energy = "Total") 
# Input values for state, year, month, producer, and energy. 
...
=======
         ...
         energy == "Coal") %>%
>>>>>>> 0807dd0a21547a4aa65cdb2959d10a0210331794
  select(name, gen)
